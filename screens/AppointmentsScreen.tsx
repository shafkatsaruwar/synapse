...
const calStyles = StyleSheet.create({
  ...
  calMonth: { fontFamily: "Inter_600SemiBold", fontSize: 15, color: C.text },
  calWeekRow: { flexDirection: "row", marginBottom: 6 },
  calWeekDay: { flex: 1, textAlign: "center", fontFamily: "Inter_500Medium", fontSize: 11, color: C.textTertiary },
  ...
  calDay: { fontFamily: "Inter_500Medium", fontSize: 13, color: C.text },
...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontFamily: "Inter_600SemiBold", fontSize: 13, color: C.textSecondary, marginBottom: 10, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  aptDateDay: { fontFamily: "Inter_700Bold", fontSize: 16, color: C.purple, lineHeight: 20 },
  aptDateMonth: { fontFamily: "Inter_500Medium", fontSize: 9, color: C.purple, textTransform: "uppercase" },
  aptDoctor: { fontFamily: "Inter_600SemiBold", fontSize: 14, color: C.text },
  aptSpec: { fontFamily: "Inter_400Regular", fontSize: 12, color: C.textSecondary, marginTop: 1 },
  aptMeta: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 6 },
  aptMetaText: { fontFamily: "Inter_400Regular", fontSize: 11, color: C.textSecondary, marginRight: 8 },
  noAptForDate: { backgroundColor: C.surface, borderRadius: 12, padding: 20, alignItems: "center", borderWidth: 1, borderColor: C.border },
  noAptText: { fontFamily: "Inter_400Regular", fontSize: 13, color: C.textTertiary },
  ...
  noteBulletNum: { fontFamily: "Inter_700Bold", fontSize: 12, color: C.green },
  noteText: { fontFamily: "Inter_400Regular", fontSize: 13, color: C.text, flex: 1, lineHeight: 19 },
