...
const styles = StyleSheet.create({
  ...
  rangeText: { fontFamily: "Inter_500Medium", fontSize: 12, color: C.textSecondary },
  ...
  cardTitle: { fontFamily: "Inter_600SemiBold", fontSize: 15, color: C.text, marginBottom: 14 },
  emptyChart: { alignItems: "center", paddingVertical: 32 },
  emptyText: { fontFamily: "Inter_400Regular", fontSize: 13, color: C.textTertiary, marginTop: 8 },
  emptySubtext: { fontFamily: "Inter_400Regular", fontSize: 11, color: C.textTertiary, marginTop: 4 },
  chart: { flexDirection: "row", alignItems: "flex-end", gap: 4, height: 160 },
  barCol: { flex: 1, alignItems: "center", justifyContent: "flex-end" },
  barValue: { fontFamily: "Inter_500Medium", fontSize: 8, color: C.textSecondary, marginBottom: 4, textAlign: "center" },
  bar: { width: "80%", minWidth: 6, borderRadius: 4 },
  barDate: { fontFamily: "Inter_400Regular", fontSize: 8, color: C.textTertiary, marginTop: 4, textAlign: "center" },
  statsGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  statItem: { flex: 1, minWidth: 70, backgroundColor: C.surfaceElevated, borderRadius: 10, padding: 12, alignItems: "center" },
  statLabel: { fontFamily: "Inter_400Regular", fontSize: 11, color: C.textTertiary, marginBottom: 4 },
  statValue: { fontFamily: "Inter_600SemiBold", fontSize: 16, color: C.text },
  trendRow: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 14, paddingTop: 14, borderTopWidth: 1, borderTopColor: C.border },
  trendText: { fontFamily: "Inter_400Regular", fontSize: 13, color: C.textSecondary },
  histRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: C.border },
  histDate: { fontFamily: "Inter_400Regular", fontSize: 13, color: C.textSecondary },
  histVal: { fontFamily: "Inter_600SemiBold", fontSize: 14, color: C.text },
