...
const styles = StyleSheet.create({
  ...
  toggleText: { fontWeight: "600", fontSize: 14, color: C.textSecondary },
  fastingFields: { marginTop: 4 },
  fieldRow: { flexDirection: "row", gap: 10, marginBottom: 12 },
  fieldLabel: { fontWeight: "500", fontSize: 12, color: C.textTertiary, marginBottom: 6 },
  fieldInput: { fontWeight: "400", fontSize: 14, color: C.text, backgroundColor: C.surfaceElevated, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: C.border },
  ...
  ramTipText: { fontWeight: "400", fontSize: 12, color: C.text, flex: 1, lineHeight: 16 },
  ...
  hydrationWarningText: { fontWeight: "400", fontSize: 11, color: C.orange, flex: 1 },
