...
const styles = StyleSheet.create({
  ...
  summaryText: { fontWeight: "400", fontSize: 14, color: C.text, lineHeight: 20 },
  insightDate: { fontWeight: "400", fontSize: 11, color: C.textTertiary, marginTop: 12 },
  insightItem: { flexDirection: "row", alignItems: "flex-start", gap: 10, marginBottom: 12 },
  insightItemTitle: { fontWeight: "500", fontSize: 13, color: C.text },
  insightItemDesc: { fontWeight: "400", fontSize: 12, color: C.textSecondary, marginTop: 2, lineHeight: 17 },
  ...
  labTrackLeft: { flex: 1 },
  labTrackTest: { fontWeight: "500", fontSize: 13, color: C.text },
  freqBadge: { backgroundColor: C.greenLight, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
  freqText: { fontWeight: "500", fontSize: 10, color: C.green },
