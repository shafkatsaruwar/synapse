...
const styles = StyleSheet.create({
  ...
  symptomName: { fontFamily: "Inter_600SemiBold", fontSize: 14, color: C.text },
  sevText: { fontFamily: "Inter_500Medium", fontSize: 12, marginTop: 2 },
  symptomNotes: { fontFamily: "Inter_400Regular", fontSize: 12, color: C.textSecondary, marginTop: 4 },
  ...
  freqName: { fontFamily: "Inter_500Medium", fontSize: 13, color: C.text, width: 100 },
  ...
  recentName: { fontFamily: "Inter_500Medium", fontSize: 13, color: C.text },
  recentDate: { fontFamily: "Inter_400Regular", fontSize: 11, color: C.textTertiary, marginTop: 2 },
  sevBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  sevBadgeText: { fontFamily: "Inter_600SemiBold", fontSize: 11 },
  ...
  sevPickNum: { fontFamily: "Inter_700Bold", fontSize: 16, color: C.textSecondary },
  sevPickLabel: { fontFamily: "Inter_400Regular", fontSize: 9, color: C.textTertiary, marginTop: 2 },
