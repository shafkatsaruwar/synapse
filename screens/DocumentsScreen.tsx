...
const styles = StyleSheet.create({
  ...
  uploadTitle: { fontFamily: "Inter_600SemiBold", fontSize: 16, color: C.text, marginBottom: 4 },
  uploadSubtitle: { fontFamily: "Inter_400Regular", fontSize: 12, color: C.textSecondary },
  loadingContent: { alignItems: "center", paddingVertical: 12 },
  loadingText: { fontFamily: "Inter_500Medium", fontSize: 14, color: C.tint, marginTop: 12 },
  ...
  docDate: { fontFamily: "Inter_600SemiBold", fontSize: 13, color: C.text },
  docSummary: { fontFamily: "Inter_400Regular", fontSize: 12, color: C.textSecondary, marginTop: 2 },
  ...
  modalHeaderTitle: { flex: 1, fontFamily: "Inter_600SemiBold", fontSize: 16, color: C.text, textAlign: "center" },
  deleteBtn: { width: 36, height: 36, alignItems: "center", justifyContent: "center" },
  modalBody: { padding: 24, paddingBottom: 60 },
  modalDate: { fontFamily: "Inter_500Medium", fontSize: 13, color: C.textSecondary, marginBottom: 8 },
  modalSummary: { fontFamily: "Inter_400Regular", fontSize: 14, color: C.text, lineHeight: 20, marginBottom: 20 },
  ...
  listText: { fontFamily: "Inter_400Regular", fontSize: 13, color: C.text },
  listSubtext: { fontFamily: "Inter_400Regular", fontSize: 11, color: C.textTertiary, marginTop: 2 },
  medItem: { flexDirection: "row", alignItems: "center", paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: C.border },
  medName: { fontFamily: "Inter_500Medium", fontSize: 14, color: C.text },
  medDetail: { fontFamily: "Inter_400Regular", fontSize: 12, color: C.textSecondary, marginTop: 2 },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
  statusText: { fontFamily: "Inter_500Medium", fontSize: 10, textTransform: "uppercase" },
  labItem: { flexDirection: "row", alignItems: "center", paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: C.border },
  labTest: { fontFamily: "Inter_500Medium", fontSize: 13, color: C.text },
  labRef: { fontFamily: "Inter_400Regular", fontSize: 11, color: C.textTertiary, marginTop: 2 },
  labRight: { alignItems: "flex-end" },
  labValue: { fontFamily: "Inter_600SemiBold", fontSize: 14 },
  labFlag: { fontFamily: "Inter_500Medium", fontSize: 10, textTransform: "uppercase", marginTop: 2 },
  instrNum: { fontFamily: "Inter_600SemiBold", fontSize: 13, color: C.purple, minWidth: 20 },
  ...
  compTitle: { fontFamily: "Inter_700Bold", fontSize: 18, color: C.text, marginBottom: 6 },
  compSubtitle: { fontFamily: "Inter_400Regular", fontSize: 13, color: C.textSecondary, marginBottom: 18, lineHeight: 18 },
  ...
  compBadgeText: { fontFamily: "Inter_600SemiBold", fontSize: 12 },
  compItem: { fontFamily: "Inter_400Regular", fontSize: 13, color: C.text, marginLeft: 10, marginBottom: 4 },
  compCloseBtn: { backgroundColor: C.tint, borderRadius: 10, paddingVertical: 12, alignItems: "center", marginTop: 6 },
  compCloseText: { fontFamily: "Inter_600SemiBold", fontSize: 14, color: "#fff" },
});
